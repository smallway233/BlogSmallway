...
permalink: /blog/android换源解决timeout或导入项目慢的问题/
tags:
  - Android
  - 学习
---
...
_请注意，左上角选择项目（Project）而不是安卓（Android）_
...
### 4\. **.idea**（如果使用IntelliJ IDEA或Android Studio）
...
### 再打开gradle/wrapper/gradle-wrapper.properties

文件长这样

![image-20250227134905744](https://smallway.oss-cn-beijing.aliyuncs.com/image-20250227134905744.png)

将distributionUrl的值写改为腾讯云地址[https://mirrors.cloud.tencent.com/gradle/](https://mirrors.cloud.tencent.com/gradle/)

**请注意，此处修改为部分修改，请保留原链接后半部分gradle-x.xx-xxx.zip**

修改后的结果为![image-20250227135046650](https://smallway.oss-cn-beijing.aliyuncs.com/image-20250227135046650.png)
